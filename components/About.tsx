    ...
    <Section title="The Mission">
      <div className="grid lg:grid-cols-12 gap-16 items-start">
        <div className="lg:col-span-7 space-y-8 text-slate-300 text-xl leading-relaxed font-light">
          <p>
            Janessa Toy bridges the gap between raw scientific observation and human understanding. 
            She specializes in <span className="text-white font-medium border-b border-blue-500/30">large-scale scientific datasets</span>, 
            supporting deep-space missions and critical Earth observation research.
          </p>
          <p>
            Currently at <span className="text-white font-bold">NASA</span>, her work involves building the 
            data infrastructure that powers our understanding of planetary systems. From validating 
            satellite telemetry to architecting automated data pipelines, she ensures mission 
            integrity through data excellence.
          </p>
          <p>
            Her tenure at <span className="text-white font-bold">Microsoft</span> and academic 
            mentorship at <span className="text-white font-bold">Del Mar College</span> reflect 
            a commitment to both technical rigor and the development of the next generation of STEM researchers.
          </p>
        </div>
