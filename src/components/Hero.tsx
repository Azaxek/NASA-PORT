    ...
    <section className="relative min-h-screen flex items-center justify-center gradient-hero overflow-hidden px-6">
      ...
      >
        <motion.div 
          ...
          className="mb-8 inline-block px-4 py-1.5 border border-blue-500/30 rounded-full bg-blue-500/10 backdrop-blur-md"
        >
        ...
        <h2 className="text-xl md:text-2xl text-slate-300 font-light mb-4 tracking-wide">
          Data Analyst <span className="text-slate-600 mx-2">|</span> Space & Earth Systems <span className="text-slate-600 mx-2">|</span> Scientific Data Infrastructure
        </h2>
        
        <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-12 leading-relaxed font-light">
          Translating complex scientific datasets into actionable intelligence for mission-critical aerospace and environmental systems.
        </p>
